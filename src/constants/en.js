...
const projects = [
  ...
  },
  {
    ...
    name: "Custom Shopify Storefront",
    tagline: "Conversion-focused e-commerce",
    description:
      "Design of a custom Shopify storefront for an Elite Agency client, with a bespoke Liquid theme and an optimized checkout flow.",
    tags: [
    ...
    isPersonal: false,
    context:
      "Client mission for Elite Agency (Bordeaux): the client had a generic Shopify theme that didn't reflect their brand and converted poorly.",
    role: "End-to-end Shopify development: theme, apps, sales funnel.",
    stack: ["Shopify", "Liquid", "JavaScript", "CSS", "On-page SEO"],
    features: [
      "Fully custom Liquid theme built from the client's brand guidelines",
      "App integration and configuration to automate order management",
      "Checkout flow redesign to reduce friction at payment",
      "On-page SEO strategy for visibility on Google and social media",
    ],
    results: "Storefront delivered and used in production by the client.",
  },
  {
    slug: "suite-outils-viip",
    name: "Internal Tools Suite",
    tagline: "Fullstack tooling for business teams",
    description:
      "Omnichannel social media hub and internal data monitoring tool for the Viip Interstis teams.",
    tags: [
    ...
    isPersonal: false,
    context:
      "At Viip Interstis (Cotonou, Benin), the customer-support and developer teams managed social media and internal data with no centralized tool.",
    role: "Fullstack developer: designed and built all 3 tools, from frontend to API.",
    stack: ["React", "Node.js", "MongoDB", "REST API"],
    features: [
      "Omnichannel app centralizing every company social account in one place",
      "Monitoring site and app for internal data management",
      "Management tool dedicated to the support and developer teams",
      "Architecture designed for several teams using it simultaneously",
    ],
    results: "Tools used daily, internally, by the company's teams.",
  },
  {
    slug: "refonte-wordpress-omega",
    name: "WordPress UX & SEO Overhaul",
    tagline: "User experience + Google visibility",
    description:
      "WordPress site overhauls for Omega Agency: custom themes and plugins, redesigned user experience, and improved organic search performance.",
    tags: [
    ...
    isPersonal: false,
    context:
      "Mission at Omega Agency (Paris): client WordPress sites with dated UX and weak organic search performance.",
    role: "WordPress developer: themes, plugins and technical SEO.",
    stack: ["WordPress", "PHP", "CSS", "Technical SEO"],
    features: [
      "Built and optimized sites focused on user experience",
      "Customized themes and plugins for each client's specific needs",
      "Audited and improved organic search (structure, speed, markup)",
    ],
    results: "Sites delivered with a modernized UX and better Google rankings.",
  },
  {
